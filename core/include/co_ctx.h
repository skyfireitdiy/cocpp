...
#endif
#endif
    co_ctx(co_stack* stack, const co_ctx_config& config, std::function<void(std::any&)> entry); // 构造函数
public:                                                                                         //
    ...
    std::function<void(std::any&)> entry() const;                                               // 获取入口函数
